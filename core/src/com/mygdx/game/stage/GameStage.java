...
import com.mygdx.game.actor.BarActor;
import com.mygdx.game.actor.BigScoreActor;
import com.mygdx.game.actor.BirdActor;
import com.mygdx.game.actor.FloorActor;
import com.mygdx.game.actor.framework.ImageActor;
import com.mygdx.game.res.Res;
import com.mygdx.game.stage.base.BaseStage;
import com.mygdx.game.util.CollisionUtils;
import com.mygdx.game.util.GameState;
...
public class GameStage extends BaseStage {
    ...
    public GameStage(MyGdxGame mainGame, Viewport viewport) {
	...
	private void checkLogic() {
		...
		if (gameState == GameState.fly) {
			...
			for (BarActor barActor : barActorList) {
				...
				if (CollisionUtils.isCollision(birdActor, barActor, Res.Physics.DEPTH)) {
					Gdx.app.log(com.mygdx.game.MyGdxGame.TAG, "Collision Bar.");
					// 小鸟碰撞到水管, 则小鸟死亡
					collisionBar();
					// 播放碰撞音效
					hitSound.play();
				...
				if (!barActor.isPassByBird() && barActor.isUpBar() && birdActor.getX() > barActor.getRightX()) {
					...
					Gdx.app.log(com.mygdx.game.MyGdxGame.TAG, "Score: " + bigScoreActor.getNum());
				}
		...
		if (CollisionUtils.isCollision(birdActor, floorActor, Res.Physics.DEPTH)) {
			Gdx.app.log(com.mygdx.game.MyGdxGame.TAG, "Collision Floor.");
			// 小鸟撞到地板, 则游戏结束
			gameOver();
			// 播放游戏结束音效
			dieSound.play();
